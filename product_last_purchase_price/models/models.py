    ...
    def action_invoice_open(self):
        ...
        for inv in self.filtered(lambda i: i.type == 'in_invoice'):
            for line in inv.invoice_line_ids:
                ...
                line.uom_id._compte_price(line.price_unit, line.product_id.uom_id)
                ...
                if unit_price > 0.0:
                    pprint(line.product_id.product_tmpl_id)
                    line.product_id.product_tmpl_id.last_purchase_price = unit_price
                #  if hasattr(line.product_id.product_َtmpl_id, 'pack'):
                    #  line.product_id.product_َtmpl_id.set_parent_pack_price()
        return res
